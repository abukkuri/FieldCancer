...
def run_this():
    ...
    while t[-1] < tend:
        ...
        rates = [current_n * rN * (K1 - current_pre - current_n) / K1, current_n * (dN + sN(t[-1])),
                 current_pre * rP * (K1 - current_pre - current_n) / K1, current_pre * (dN + cP(current_n,current_pre,current_mal) + sP(t[-1])),
                 current_mal * rM* (K2 - current_mal) / K2, current_mal * (dN + cM(current_n,current_pre,current_mal) + sM(t[-1]))]
